const buildType = process.env.REACT_APP_BUILD_TYPE || 'dev'; // dev | test
const protocol = `http${process.env.REACT_APP_HTTPS === 'true' ? 's' : ''}://`;
export const initialPath = process.env.REACT_APP_PATH || '';
...
export const socialAppIdVk = process.env.REACT_APP_SOCIAL_APP_ID_VK;
export const socialAppIdOk = process.env.REACT_APP_SOCIAL_APP_ID_OK;
export const socialAppIdFb = process.env.REACT_APP_SOCIAL_APP_ID_FB;
...
export const siteTitle = process.env.REACT_APP_SITE_TITLE;
